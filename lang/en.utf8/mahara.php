...
$string['pluginexplainaddremove'] = 'Plugins in Academe ePortfolios are always installed and can be accessed if people know the URLs and would otherwise have access. Rather than enabling and disabling the functionality, plugins are hidden or made visible by clicking on the \'Hide\' or \'Show\' links beside the plugins below.';
$string['pluginexplainartefactblocktypes'] = 'When hiding an \'artefact\' type plugin, Academe ePortfolios also stops the display of the blocks related to it.';
...
$string['phpuploaderror_7'] = 'Failed to write file to disk. Check that your filesystem has enough space to write to the Academe ePortfolios dataroot and/or the PHP \'upload_tmp_dir\' directories.';
...
$string['artefacts'] = 'Artefacts';
$string['posts'] = 'Posts';
$string['facebookdescription'] = 'Academe ePortfolios is an open-source ePortfolio & Competency Platform.
...
$string['styleguide_description'] = 'This style guide describes all the different types of components used by Academe ePortfolios. They are in one place so you can easily check if you have styled everything when you are developing a new theme or plugin. Apply a different theme to your site to see what the individual components look like.';
