{include file='header.tpl' nosearch=true}
            <h2 class="center"><a href="https://github.com/AcademeResearch/ePortfolios">ePortfolios</a> {str section='admin' tag='release' args=$releaseargs}</h2>
...
along with this program.  If not, see <a href="http://www.gnu.org/licenses/gpl.html">http://www.gnu.org/licenses/</a>.
            ...
            <div class="alert alert-info">Before you install ePortfolios, you may want to check out the <a href="https://github.com/AcademeResearch/ePortfolios/wiki">release notes</a> for this release.</div>
