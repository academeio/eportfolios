...
$string['bypassindexnamedescription'] = '(Optional) If provided, Academe ePortfolios will load index data into this index name instead of the main index name.';
...
$string['newversion'] = 'A new Elasticsearch PHP version %s has been added to Academe ePortfolios that is compatible with Elasticsearch server %s and above. For this to take effect, you will need to reindex your site.';
$string['none'] = 'none';
