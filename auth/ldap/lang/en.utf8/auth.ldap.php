...
$string['syncuserscreate'] = 'Auto-create accounts via a cron job';
$string['syncuserscron'] = 'Sync accounts automatically via a cron job';
$string['syncusersextrafilterattribute'] = 'Additional LDAP filter for sync';
$string['syncuserssettings'] = 'Account sync';
$string['syncusersupdate'] = 'Update account information via a cron job';
$string['syncusersgonefromldap'] = 'If an account is no longer present in LDAP';
$string['syncusersgonefromldapdonothing'] = 'Do nothing';
$string['syncusersgonefromldapsuspend'] = 'Suspend account';
$string['syncusersgonefromldapdelete'] = 'Delete account and all content';
$string['userattribute'] = 'User attribute';
$string['usertype'] = 'User type';
$string['weautocreateusers'] = 'We auto-create accounts';
$string['updateuserinfoonlogin'] = 'Update account information on login';
