...
$string['description'] = 'Web services-only users authenticated against ePortfolios\'s database';
...
$string['nodefinedconnections'] = 'There are no web service connections defined in any plugin. Please define a connection first.';
...
$string['manage_certificates'] = 'These are the certificates generated as part of <a href="%s">Networking</a> services. These values are used by ePortfolios when web services security signatures and encryption are enabled for a particular web services token or service user (only XML-RPC and legacy MNet).';
...
$string['servicenamemissing'] = 'No services available. Please make sure web services are enabled and active for this authentication type.';
...
$string['allsites'] = 'Access to all institutions';
...
$string['errorunexpectedcustomkey'] = 'Unexpected custom keys (%s) detected in parameter array. They are being ignored by ePortfolios. This message is informational only so you can review the parameters and are aware that they are being ignored.';
...
$string['nosites'] = 'No access to any institution';
$string['nowsprotocolsenabled'] = 'No web service protocols are enabled. You need at least one <a href="%s">protocol</a> enabled.';
$string['onesystemcontrolling'] = 'One system controlling ePortfolios with a token';
...
$string['membersinvalidaction'] = 'Invalid action "%s" for account holder "%s" in group "%s"';
...
$string['unabletodeleteadmin'] = 'Unable to delete account with ID "%s" as it is an administrator account';
