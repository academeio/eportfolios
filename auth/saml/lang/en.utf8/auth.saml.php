...
$string['reallyreallysure1'] = "You are trying to save the Service Provider metadata for ePortfolios. This cannot be undone. Existing SAML logins will not work until you have reshared your new metadata with all Identity Providers.";
$string['reset'] = 'Reset metadata';
$string['resetmetadata'] = 'Reset the certificates for ePortfolios\'s metadata. This cannot be undone, and you will have to reshare your metadata with the Identity Provider.';
