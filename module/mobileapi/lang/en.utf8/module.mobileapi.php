...
$string['maharamobile'] = 'Academe ePortfolios Mobile API';
...
$string['noticeenabled'] = 'The Academe ePortfolios mobile apps API is enabled.';
$string['noticenotenabled'] = 'The Academe ePortfolios mobile apps API is <strong>not</strong> enabled.';
...
$string['mytokensmenutitle1'] = 'Academe ePortfolios Mobile';
$string['mytokenspagetitle1'] = 'Academe ePortfolios Mobile tokens';
